<?php require_once '../../logica/tipo_permiso.php';
$tipoPerm = new TipoPermiso();
$allTipoPerm = $tipoPerm -> getTipoPermiso();
          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
                  <div class="x_title">
                    <h2>Agregar un tipo de permiso</h2>
                  ...
                  <div class="x_content">
										...
										<form class="form-horizontal form-label-left" novalidate method="post">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12 form-group">
													<input type="text" class="form-control has-feedback-left" id="descripcion" name="descripcion" placeholder="Nivel de remuneración">
													<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
												</div>
											</div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
												<?php foreach ($allTipoPerm as $dts)
												{
												 ?>
                        <tr>
                          <td><?php echo $dts->id_tipo_permiso; ?></td>
